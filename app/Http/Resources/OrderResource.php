...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'pickup_location' => [$this->resource->pickup_location->y, $this->resource->pickup_location->x],
            'dropoff_location' => [$this->resource->dropoff_location->y, $this->resource->dropoff_location->x],
