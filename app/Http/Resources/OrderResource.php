...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'pickup_location' => [$this->resource->pickup_location->x, $this->resource->pickup_location->y],
            'dropoff_location' => [$this->resource->dropoff_location->x, $this->resource->dropoff_location->y],
