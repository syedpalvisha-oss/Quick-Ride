<x-layouts.app title="Login — OpenJek">
    ...
    <div class="flex min-h-screen items-center justify-center px-6 py-12">
        ...
        <div class="animate-fade-up relative w-full max-w-md">
            ...
            <div class="mb-10 text-center">
                ...
                <p class="mt-2 text-sm text-void-300">Sign in to your account</p>
            </div>
            ...
            >
                ...
                {{-- Toggle: Phone / Email --}}
                <div class="mb-6 flex rounded-lg border border-void-700 bg-void-800/50 p-1">
                    <button
                        type="button"
                        x-on:click="useEmail = false"
                        :class="!useEmail ? 'bg-void-700 text-void-50' : 'text-void-400 hover:text-void-200'"
                        class="flex-1 rounded-md px-3 py-1.5 text-sm font-medium transition"
                    >Phone</button>
                    <button
                        type="button"
                        x-on:click="useEmail = true"
                        :class="useEmail ? 'bg-void-700 text-void-50' : 'text-void-400 hover:text-void-200'"
                        class="flex-1 rounded-md px-3 py-1.5 text-sm font-medium transition"
                    >Email</button>
                </div>
                ...
                {{-- Phone --}}
                <div x-show="!useEmail" class="mb-4">
                    <label for="login-phone" class="mb-1.5 block text-sm font-medium text-void-200">Phone</label>
                ...
                {{-- Email --}}
                <div x-show="useEmail" class="mb-4">
                    <label for="login-email" class="mb-1.5 block text-sm font-medium text-void-200">Email</label>
                    <input
                        id="login-email"
                        type="email"
                        x-model="email"
                ...
                {{-- Password --}}
                <div class="mb-6">
                    <label for="login-password" class="mb-1.5 block text-sm font-medium text-void-200">Password</label>
                    <input
                        id="login-password"
                        type="password"
                        x-model="password"
            ...
            <p class="mt-6 text-center text-sm text-void-400">
                ...
                <a href="/register" class="font-medium text-neon-400 transition hover:text-neon-300">Sign up</a>
            </p>
        </div>
    </div>
